...
set_hitbox_value(AT_NSPECIAL, 1, HG_DAMAGE, 3); // Damage
...
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("projectile"));
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_MASK, sprite_get("projectile"));
