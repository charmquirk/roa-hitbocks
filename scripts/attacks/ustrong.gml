...
set_hitbox_value(AT_USTRONG, 1, HG_LIFETIME, 40);
...
set_hitbox_value(AT_USTRONG, 1, HG_DAMAGE, 20); // Damage
...
set_hitbox_value(AT_USTRONG, 1, HG_PROJECTILE_PARRY_STUN, false);
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT, 3);
set_hitbox_value(AT_USTRONG, 1, HG_PROJECTILE_SPRITE, sprite_get("projectile"));
set_hitbox_value(AT_USTRONG, 1, HG_PROJECTILE_MASK, sprite_get("projectile"));
set_hitbox_value(AT_USTRONG, 1, HG_PROJECTILE_ANIM_SPEED, 1);
set_hitbox_value(AT_USTRONG, 1, HG_PROJECTILE_DESTROY_EFFECT, 13);
