...
set_hitbox_value(AT_DSTRONG, 1, HG_DAMAGE, 20); // Damage
...
set_hitbox_value(AT_DSTRONG, 1, HG_PROJECTILE_SPRITE, sprite_get("projectile"));
set_hitbox_value(AT_DSTRONG, 1, HG_PROJECTILE_MASK, sprite_get("projectile"));
set_hitbox_value(AT_DSTRONG, 1, HG_PROJECTILE_ANIM_SPEED, 1);
